...
<head>
    ...
    <style>
        @import url("/resources/css/layout.css") screen and (min-width:960px);
        @import url("/resources/css/layout_response.css") screen and (min-width:801px) and (max-width:959px);
        @import url("/resources/css/layout_min.css") screen and (max-width:800px);
...
<body>
    <div class="wrap">
        ...
        <div class="wrap-main">
         <%@include file="/WEB-INF/views/join/section.jsp" %>
